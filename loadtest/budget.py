"""Budget exhaustion (SPEC C11): drive team 'spendy' (high RPM, $0.25/day,
cache off) to its daily cap -> Slack warn at 80%, clean budget-exhausted
429s at 100%."""
...
from loadtest.common import RESULTS_DIR, SPENDY_KEY, chat_body, headers, load_corpus
...
class BudgetBurner(HttpUser):
    ...
    def burn(self) -> None:
        ...
        with self.client.post(
            ...
            headers=headers(SPENDY_KEY), name="chat[budget]", catch_response=True,
        ) as resp:
